...
export default class ShopScreenExample extends React.Component {
              ...
              <CardItem style={styles.cardStyle}>
                <Left>
                  ...
                  <Body>
                    ...
                    <Text style={styles.text}> Exemplo, vendo produtos feitos em minha horta. Entrego praca XV e regiao. Vamos entrar em contato!</Text>
                  </Body>
                </Left>
              </CardItem>
            </Card>
